  ...
  <div class="">
    ...
    <div class="text-center mt-5">
      ...
      <!-- COLOQUE OS LINKS URL, PARA AS REDES SOCIAIS NO HREF DE CADA UM. COMO VISTO ABAIXO O LINKEDIN ESTA DESATIVADO TIRE A TAG DE COMENTARIO PARA REATIVA-LO-->
        ...
        <!-- Facebook -->
        <a class="icones facebook" aria-label="Facebook do BLOG" href="#" target="_blank" rel="noopener">
    ...
    <!-- Texto do rodape-->
    <div class="mt-5">
      <p class="m-0 text-center font-weight-bold text-white"> &copy; 2021 BLOG</p>
    </div>
  </div>
</footer>
<!-- FIM do Rodapé -->
...
<!-- Topo da Tela -->
<a class="subirTopo" aria-label="voltar ao topo">

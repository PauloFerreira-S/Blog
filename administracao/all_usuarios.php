...
<body>
    ...
    <div class="p-5 bg-tema">
        <h1 class="tituloPrincipalBlog mt-4 mb-3">Usuarios Criados</h1>
    </div>
    ...
    <div class="container">
        ...
        <ol class="breadcrumb bg-breadTema texto-bread mt-5">
            ...
            <li class="breadcrumb-item active">Usuarios Criados</li>
        </ol>

        <!-- Criando o Post -->

        <h3>Usuarios Criados</h3>
                    ...
                    while ($dado = $con->fetch_array()) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-secund" href="/administracao/editar_usuario.php?buscaNome=<?php echo $nome_novo; ?>">Editar</a>
                                <a class="btn btn-secund" href="/administracao/deletar_usuario.php?buscaNome=<?php echo $nome_novo; ?>">Excluir</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
